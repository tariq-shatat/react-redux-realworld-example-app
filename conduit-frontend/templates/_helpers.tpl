...
helm.sh/chart: {{ include "conduit-frontend.chart" . }}
{{ include "conduit-frontend.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
{{- default (include "conduit-frontend.fullname" .) .Values.serviceAccount.name }}
{{- else }}
